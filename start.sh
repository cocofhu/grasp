...
: "${GRASP_IMAGE:=ghcr.io/cocofhu/grasp:1.0.1}"
: "${SANDBOX_GATEWAY_IMAGE:=ghcr.io/cocofhu/sandbox-gateway:1.0.1}"
: "${SANDBOX_GATEWAY_API_KEY:=grasp-local-demo}"

# One published sandbox image (five CLIs inside; runtime AGENT_PROVIDER picks).
: "${SANDBOX_IMAGE:=ghcr.io/cocofhu/universal-sandbox:1.0.1}"
