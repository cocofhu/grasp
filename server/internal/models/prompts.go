...
const (
	...
	// DefaultApproveConfirmProductsReadyNote so the agent skips a no-op rewrite.
	...
	// DefaultApproveConfirmProductsReadyNote is appended to the Approve confirm
